...
public class Utils {
    ...
    public static APIResponse<Bitmap> decodeBitmap(Response response, int maxWidth,
    ...
    public static APIResponse<Bitmap> decodeBitmap(Response response, int maxWidth,
        ...
        if (bitmap == null) {
            return APIResponse.failed(Utils.getErrorForParse(new APIError(response)));
        } else {
    ...
    public static APIError getErrorForConnection(APIError error) {
        error.setErrorDetail(APIConstants.CONNECTION_ERROR);
        error.setErrorCode(0);
        return error;
    }


    public static APIError getErrorForServerResponse(APIError error, APIRequest request, int code) {
        error = request.parseNetworkError(error);
        error.setErrorCode(code);
        error.setErrorDetail(APIConstants.RESPONSE_FROM_SERVER_ERROR);
        return error;
    }

    public static APIError getErrorForParse(APIError error) {
        error.setErrorCode(0);
        error.setErrorDetail(APIConstants.PARSE_ERROR);
        return error;
    }
